        ...
        <div class="container p-2">
            ...
            <div class="navbar navbar-expand-md">
                ...
                <div class="dropdown d-none d-lg-block">
                    ...
                    <li><a class="dropdown-item my-1 d-flex align-items-center" href="/admin/backup.php"><i class="far fa-file-alt me-2"></i>Backup & Restore</a></li>
                    ...
                    <li><a class="dropdown-item my-1 d-flex align-items-center" href="/users/library.php"><i class="far fa-bookmark me-2"></i>My Library</a></li>
                    <li><a class="dropdown-item my-1 d-flex align-items-center" href="/users/my-submissions.php"><i class="far fa-file-alt me-2"></i>My Submissions</a></li>
                    <li><a class="dropdown-item my-1 d-flex align-items-center text-danger" href="/src/process/logout.php"><i class="fas fa-sign-out-alt me-2"></i>Sign out</a></li>
                    </ul>';
                    }
                    ?>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body">
        ...
        if ($_SESSION['userType'] === "admin") {
            ...
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center offcanvas-link-color" href="/admin/backup.php"><i class="far fa-file-alt me-2"></i>Backup & Restore</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center offcanvas-link-color" href="/users/library.php"><i class="far fa-bookmark me-2"></i>My Library</a>
            </li>
            <li class="nav-item">
