    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 my-1">
                <a href="/home.php"><img src="/assets/images/core/saliksik-logo.png" id="footer-logo" alt="" class="img-fluid saliksik-logo mb-2"></a>
            ...
            <div class="col-lg-4 my-1">
                ...
                <ul class="footer-list">
                    <li><a class="footer-list-link ext-link" href="http://gti-binan.dyndns.org:8339/index.htm" target="_blank">School Automate</a></li>
                    <li><a class="footer-list-link ext-link" href="https://lmsbinan.uphsl.edu.ph/moodle/" target="_blank">LMS Biñan (Moodle)</a></li>
                    <li><a class="footer-list-link ext-link" href="http://gti-binan.dyndns.org:8339/lms/" target="_blank">Online Library</a></li>
