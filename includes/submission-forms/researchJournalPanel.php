...
<div class=" col-lg-10 px-5 col-md-12 col-xs-12 main-column" id="researchJournalPanel" hidden>
    ...
    <form name="journal-form">
        ...
        <div class="row">
            <div class="col">
                <input type="submit" class="btn btn-primary button-submit-research rounded-0 my-3" value="Upload to Repository" id="submitJournalButton" <?php if ($_SESSION['userType'] !== "admin") {
                                                                                                                                                                echo 'disabled';
                                                                                                                                                            } ?>>
            </div>
        </div>
