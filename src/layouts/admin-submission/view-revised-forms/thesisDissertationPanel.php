...
<div class="row">
    ...
    <div class="col-lg-10 px-5 col-md-12 col-xs-12 main-column" id="thesisDissertationPanel">
        ...
        <form onsubmit="submitForm(event)" name="thesis-form" data-id="<?= $fileInfo['file_id'] ?>" data-coauthor_id="<?= $fileInfo['coauthor_group_id'] ?>">
            ...
            <div class="row my-4">
                <div class="form-check m-2">
                    <input class="form-check-input" type="checkbox" id="needsRevisionThesis" name="needsRevision" value="for revision" onclick="enableRevisionThesis(this);" checked>
                    <label for="needsRevisionThesis" class="text-danger">Needs Revision</label>
                </div>
            </div>

            <div class="row" id="publishButtonThesis" style="display:none">
                <div class="col">
            ...
            <div class="row" id="textAreaFeedbackThesis">
                <div class="col">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="textAreaFeedbackThesis" rows="10" placeholder="Write your comment..."><?php echo htmlspecialchars($fileInfo['feedback']); ?></textarea>
                    </div>
                </div>
            </div>
