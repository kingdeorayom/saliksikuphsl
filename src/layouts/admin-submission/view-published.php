        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            checkFileInfo().then((item) => {
                ...
                if (fileInfo !== null) { //checks if file exists
                    if (fileInfo["status"] === "published") { // checks if file status matches pending
    ...
    <section class="submit-research" style="font-family: 'Roboto';">
        <div class="container p-5">
            <div class="row my-3 d-lg-none">
                ...
                <hr>
                <p class="side-menu-text">Published by:</p>
                <p class="side-menu-text">Admin</p>
                <hr>
                <p class="side-menu-text">Published on:</p>
                <p class="side-menu-text">2021-11-17 08:52:03</p>
                <hr>
                <p class="side-menu-text">Last edit on:</p>
                <p class="side-menu-text">2021-11-17 08:52:03</p>
                <hr>
            </div>
            <div class="row">
