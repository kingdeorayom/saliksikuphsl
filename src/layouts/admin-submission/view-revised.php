        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            checkFileInfo().then((item) => {
                ...
                if (fileInfo !== null) { //checks if file exists
                    if (fileInfo["status"] === "revised") { // checks if file status matches
            ...
            function thesisFill(fileInfo) {
                ...
                thesisInputs[47].checked = true
                enableRevisionThesis(thesisInputs[47])
                thesisInputs[49].value = fileInfo.feedback
            ...
            function journalFill(fileInfo) {
                ...
                journalInputs[14].checked = true;
                enableRevisionJournal(journalInputs[14])
                journalInputs[16].value = fileInfo.feedback
            ...
            function infographicFill(fileInfo) {
                ...
                infographicInputs[39].checked = true
                enableRevisionInfographics(infographicInputs[39]);
                infographicInputs[40].value = fileInfo.feedback
