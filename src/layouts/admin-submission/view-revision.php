        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            checkFileInfo().then((item) => {
                ...
                if (fileInfo !== null) { //checks if file exists
                    if (fileInfo["status"] === "for revision") { // checks if file status matches
            ...
            function thesisFill(fileInfo) {
                ...
                thesisInputs[47].value = fileInfo.feedback
            ...
            function journalFill(fileInfo) {
                ...
                journalInputs[14].value = fileInfo.feedback
            ...
            function infographicFill(fileInfo) {
                ...
                infographicInputs[39].value = fileInfo.feedback
