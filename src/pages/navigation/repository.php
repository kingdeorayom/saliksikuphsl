            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="input-group my-3">
                        <input type="search" class="form-control form-search rounded-0" id="repository-search-bar" aria-label="Search the repository" aria-describedby="button-addon2" <?php if (isset($_GET['query'])) {
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination d-flex justify-content-center">
                                <li class="page-item" <?php if ($page == 1) {
                                                            echo 'hidden';
                                                        } ?>><a class="page-link" href=<?php echo '?page=' . $page - 1 ?>>Previous</a></li>
                                ...
                                <li class="page-item" <?php if ($page >= $total_pages) {
                                                            echo 'hidden';
                                                        } ?>><a class="page-link" href=<?php echo '?page=' . $page + 1 ?>>Next</a></li>
                            </ul>
